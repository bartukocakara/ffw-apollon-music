      ...
      <div class="offcanvas-body swiper scrollbar-hover overflow-hidden w-100 p-4" data-swiper-options='{
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide h-auto">
                <h3 class="fs-lg">
                    <a href="typography.html" class="list-group-item list-group-item-action border-0 py-2 px-4">
                        Users
                    </a>
                </h3>

            <h3 class="fs-lg">Users</h3>
            <div class="list-group list-group-flush border-bottom pb-3 mb-4 mx-n4">
              <a href="accordion.html" class="list-group-item list-group-item-action border-0 py-2 px-4">List</a>
