<section class="container py-5 my-md-3 my-lg-5 text-white">
    <h2 class="h1 text-center pt-1 pb-3 mb-3 mb-lg-4 text-white">How it works?</h2>
    <p class="text-center" style="margin-top: 20px; margin-bottom: 20px;">Compose Unique Music from Images in 4 Steps with Apollon Engine</p>
